...
export default function MealsCard({ item }) {
    // Calculate fat (placeholder - you can add actual fat data to your mealsData)
    const calorieNum = typeof item.calorie === 'string' ? parseFloat(item.calorie) : item.calorie
    const fat = Math.round((calorieNum * 0.3) / 9) // Rough estimate: 30% of calories from fat
                ...
                <div style={{
                        ...
                        <div className={styles.nutrientContent}>
                            ...
                            <div className={styles.nutrientValues}>
                                <span className={styles.nutrientValue}>
                                    {formatNumber(item.protein || item.proteins)}g
                                </span>
                                <Image 
                    ...
                    <div className={styles.nutrientBox}>
                        <div className={styles.nutrientContent}>
                            ...
                            <div className={styles.nutrientValues}>
                                <span className={styles.nutrientValue}>
                                    {formatNumber(item.carbohydrate || item.carbohydrates)}g
                                </span>
                                <Image 
                                    src="/logos/check-icon.png" 
                                    alt="✓" 
